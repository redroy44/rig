...
## [Unreleased]
## [0.41.0](https://github.com/redroy44/rig/compare/rig-core-v0.40.0...rig-core-v0.41.0) - 2026-07-24

### Added

- [**breaking**] split rig-core and rig-agent behind the rig facade ([#2197](https://github.com/redroy44/rig/pull/2197)) (by [gold-silver-copper](https://github.com/gold-silver-copper)) - #2197
- *(agent)* add response retry hooks ([#2182](https://github.com/redroy44/rig/pull/2182)) (by [gold-silver-copper](https://github.com/gold-silver-copper))
- *(doubleword)* add provider with cassette coverage ([#2163](https://github.com/redroy44/rig/pull/2163)) (by [gold-silver-copper](https://github.com/gold-silver-copper))
- *(telemetry)* make sensitive span content opt-in ([#2151](https://github.com/redroy44/rig/pull/2151)) (by [gold-silver-copper](https://github.com/gold-silver-copper))
- *(openai)* expose complete Responses reasoning metadata ([#2112](https://github.com/redroy44/rig/pull/2112)) (by [gold-silver-copper](https://github.com/gold-silver-copper))
- *(openai)* support GPT-5.6 models and reasoning controls ([#2106](https://github.com/redroy44/rig/pull/2106)) (by [gold-silver-copper](https://github.com/gold-silver-copper))

### Fixed

- *(openai)* accept nullable strict tool definitions ([#2178](https://github.com/redroy44/rig/pull/2178)) (by [gold-silver-copper](https://github.com/gold-silver-copper))
- *(anthropic)* support code execution tool results ([#2158](https://github.com/redroy44/rig/pull/2158)) (by [gold-silver-copper](https://github.com/gold-silver-copper))
- *(agent)* prevent structured-output tools from shadowing real tools ([#2146](https://github.com/redroy44/rig/pull/2146)) (by [gold-silver-copper](https://github.com/gold-silver-copper))
- *(gemini)* preserve image generation error envelopes ([#2147](https://github.com/redroy44/rig/pull/2147)) (by [gold-silver-copper](https://github.com/gold-silver-copper))
- *(core)* make Extractor usage accounting match its docs, drop per-attempt clones, fix retry log ([#2109](https://github.com/redroy44/rig/pull/2109)) (by [gold-silver-copper](https://github.com/gold-silver-copper))

### Other

- Make managed agent hooks provider-independent ([#2176](https://github.com/redroy44/rig/pull/2176)) (by [gold-silver-copper](https://github.com/gold-silver-copper)) - #2176
- Remove built-in agent dynamic context ([#2174](https://github.com/redroy44/rig/pull/2174)) (by [gold-silver-copper](https://github.com/gold-silver-copper)) - #2174
- Make AgentRunner the only Agent execution path ([#2161](https://github.com/redroy44/rig/pull/2161)) (by [gold-silver-copper](https://github.com/gold-silver-copper)) - #2161
- Add rig-candle local inference and WASM chat ([#2155](https://github.com/redroy44/rig/pull/2155)) (by [gold-silver-copper](https://github.com/gold-silver-copper)) - #2155
- *(providers)* share embedding transport ([#2157](https://github.com/redroy44/rig/pull/2157)) (by [gold-silver-copper](https://github.com/gold-silver-copper))
- Simplify tool execution and hook APIs ([#2132](https://github.com/redroy44/rig/pull/2132)) (by [gold-silver-copper](https://github.com/gold-silver-copper)) - #2132
- *(telemetry)* centralize completion span lifecycle ([#2115](https://github.com/redroy44/rig/pull/2115)) (by [gold-silver-copper](https://github.com/gold-silver-copper))
- *(core)* [**breaking**] make core errors non-exhaustive ([#2114](https://github.com/redroy44/rig/pull/2114)) (by [gold-silver-copper](https://github.com/gold-silver-copper))
- *(core)* deduplicate HttpClientExt implementations ([#2113](https://github.com/redroy44/rig/pull/2113)) (by [gold-silver-copper](https://github.com/gold-silver-copper))
- bump rmcp depency to latest ([#2103](https://github.com/redroy44/rig/pull/2103)) (by [ThomasMarches](https://github.com/ThomasMarches)) - #2103
- *(core)* collapse Extractor's four retry loops into one private helper ([#2107](https://github.com/redroy44/rig/pull/2107)) (by [gold-silver-copper](https://github.com/gold-silver-copper))
